...
L["A new tier is here!  You should probably reset or rescale GP (Interface -> Options -> AddOns -> EPGP)!"] = "新的级别出现！你可能需要重置或重新调整GP （界面-> 选项-> 插件-> EPGP）！"
L["Alts"] = "马甲"
...
L["Announce when someone in your raid derps a bonus roll"] = "当团队内有人用幸运币没有获得好装备时通报"
...
L["Award EP"] = "奖励EP"
L["Awards for wipes on bosses. Requires DBM, DXE, or BigWigs"] = "对boss战灭团进行奖励.需要DBM,DXE,或BigWigs插件."
...
L["GP (not EP) is reset"] = "GP (不是EP) 被重置了"
L["GP (not ep) reset"] = "重置GP （非EP）"
L["GP is rescaled for the new tier"] = "为了新等级, GP被重新调整了"
L["GP on tooltips"] = "在工具栏提示中显示GP"
L["GP Reason"] = "GP原因"
L["GP rescale for new tier"] = "为了新等级重新调整GP"
L["GP: %d"] = true
...
--Translation missing 
-- L["Main"] = ""
L["Make sure you are the only person changing EP and GP. If you have multiple people changing EP and GP at the same time, for example one awarding EP and another crediting GP, you *are* going to have data loss."] = "确保你是唯一一个正在变更EP和GP的人。如果有多人同时变更EP和GP，比如一个人正在发放EP时另一个人记录GP，你*必定*会丢失数据。"
L["Mass EP Award"] = "群体EP奖励"
L["Min EP should be a positive number"] = "MinEP(最低贡献点数)应为正数"
L["must be equal to or higher than %s"] = "必须高于或者等于 %s"
...
L["Other"] = "其它"
L["Outsiders should be 0 or 1"] = "替补为0或1"
...
L["Redo"] = "重做"
L["Re-scale all main toons' GP to current tier?"] = "重新调整所有大号GP到当前级别"
L["Rescale GP"] = "衰减GP"
L["Rescale GP of all members of the guild. This will reduce all main toons' GP by a tier worth of value. Use with care!"] = "重新调整所有公会成员GP. 这样做会使所有主号的GP下降一个等级. 请小心使用!"
L["Reset all main toons' EP and GP to 0?"] = "重置所有主角色的EP及GP为零?"
L["Reset all main toons' GP to 0?"] = "重设所有人GP到0?"
L["Reset EPGP"] = "重置EPGP"
L["Reset only GP"] = "只重设GP"
...
L["Resets GP (not EP!) of all members of the guild. This will set all main toons' GP to 0. Use with care!"] = "重设所有工会成员的GP(不是EP!). 这样做将会使所有主号的GP清零. 请小心使用!"
...
L["Whisper"] = "密语"
L["Wipe awards"] = "灭团奖励"
L["Wiped on %s. Award EP?"] = "在 %s 的战斗中灭团. 奖励EP?"
