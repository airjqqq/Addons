...
L["Show only if player is in combat"] = "플레이어가 전투 중인 경우에만 표시"
L["Show only if unit is in combat"] = "유닛이 전투 중인 경우에만 표시"
...
L["Support standart blizzard or OmniCC"] = "블리자드 표준 또는 OmniCC 지원"
