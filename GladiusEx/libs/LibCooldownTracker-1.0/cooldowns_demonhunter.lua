local data = {
  ...
  [179057] = { default = false, cooldown = 60, class = "DEMONHUNTER", cc = "stun", duration = 5 }, -- Chaos Nova
  [183752] = { default = true, cooldown = 15, class = "DEMONHUNTER" , interrupt = true}, -- Consume Magic
  [188499] = { default = false, cooldown = 10, class = "DEMONHUNTER", defensive = 0.5, immune = "evasion", duration = 1 }, -- Blade Dance
  [188501] = { default = false, cooldown = 30, class = "DEMONHUNTER", offensive = 0, duration = 10 }, -- Spectral Sight
  ...
  [206649] = { default = false, cooldown = 45, class = "DEMONHUNTER", important = true, duration = 6 }, -- Eye of Leotheras
  ...
  [196555] = { default = false, cooldown = 90, class = "DEMONHUNTER", defensive = 1, duration = 5, talent = {212800} }, -- Netherwalk
  [214743] = { default = false, cooldown = 60, class = "DEMONHUNTER" }, -- Soul Carver
  [207407] = { parent = 214743 }, -- Soul Carver (Vengeance)
  [221527] = { default = false, cooldown = 60, class = "DEMONHUNTER", cc = "incapacitate", duration =5}, -- Imprison
  ...
  [211881] = { default = false, cooldown = 35, class = "DEMONHUNTER", specID = { 577, 581 }, cc = "stun", duration = 2 }, -- Fel Eruption
  ...
  [205629] = { default = false, cooldown = 30,  class = "DEMONHUNTER", specID = { 581 }, talent = {}, offensive = 0, duration = 8 }, -- Demonic Trample
  [205630] = { default = false, cooldown = 90, class = "DEMONHUNTER", specID = { 581 }, talent = {}, cc = "stun", duration = 3 }, -- Illidan's Grasp
  [207684] = { default = false, cooldown = 60, class = "DEMONHUNTER", specID = { 581 } }, -- Sigil of Misery
  [207810] = { default = false, cooldown = 120, class = "DEMONHUNTER", specID = { 581 }, defensive = 0.5, duration = 15 }, -- Nether Bond
  [218256] = { default = false, cooldown = 20, class = "DEMONHUNTER", specID = { 581 }, defensive = 0.15, duration = 6 }, -- Empower Wards
  [227225] = { default = false, cooldown = 20, class = "DEMONHUNTER", specID = { 581 },defensive = 0.2, duration = 8, talent = {} }, -- Soul Barrier
