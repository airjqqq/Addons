local data = {
  ...
  [ 55342] = { default = true, cooldown = 120, class = "MAGE", offensive = 0.1, talent = {}, duration = 40 }, -- Mirror Image
  [ 80353] = { default = false, cooldown = 300, class = "MAGE", offensive = 0.3, duration = 40, dispellable = true }, -- Time Warp
  [108839] = { default = true, cooldown = 20, class = "MAGE", charges = 3, sprint = true, dispellable = true, duration = 15 }, -- Ice Floes
  [113724] = { default = true, cooldown = 45, class = "MAGE", cc = true , talent = {108839}, aura = {82691} }, -- Ring of Frost
  ...
  [205029] = { default = true, cooldown = 45, class = "MAGE", specID = { 63 }, offensive = true }, -- Flame On
  ...
  [157997] = { default = true, cooldown = 25, class = "MAGE", specID = { 64 }, offensive = true}, -- Ice Nova
  ...
  [ 33395] = { default = true, cooldown = 24, class = "MAGE", specID = { 64 }, duration = 8, cc = "root" }, -- Freeze (Water Elemental)
