local data = {
  ...
  [  1766] = { default = trye, cooldown = 15, class = "ROGUE", interrupt = true }, -- Kick
  ...
  [  1833] = { default = false, class = "ROGUE", cc = "stun", duration = 4 }, -- Cheap Shot
  [  6770] = { default = false, class = "ROGUE", cc = "incapacitate", duration = 8 }, -- Cheap Shot

  -- Assassination

  [   408] = { default = true, cooldown = 20, class = "ROGUE", specID = { 259, 261 }, cc= "stun", duration = 6 }, -- Kidney Shot
  [   703] = { default = false, cooldown = 15, class = "ROGUE", specID = { 259 }, cc= "silence", duration = 3, aura = {1330} }, -- Garrote
  ...
  [  1776] = { default = false, cooldown = 10, class = "ROGUE", specID = { 260 }, cc = "incapacitate", duration = 4 }, -- Gouge
  [  2094] = { default = true, cooldown = 120, class = "ROGUE", cc = "disorient", duration = 8 }, -- Blind
  ...
  [185313] = { default = false, cooldown = 20, class = "ROGUE", specID = { 261 }, charges = 3, offensive = 0.2, duration = 8 }, -- Shadow Dance
  [207736] = { default = false, cooldown = 120, class = "ROGUE", specID = { 261 }, talent = {}, offensive = 0.2, duration = 6 }, -- Shadowy Duel
  ...
  [212183] = { default = false, cooldown = 180, class = "ROGUE", specID = { 261 }, important = true, duration = 5 }, -- Cold Blood
