local data = {
  ...
  [  1122] = { default = false, cooldown = 180, class = "WARLOCK", cc = "stun", offensive = true, aura = {22703}, duration = 2 }, -- Summon Infernal
  [  6358] = { default = false, cooldown = 30, class = "WARLOCK", cast = 1.7, cc= "disorient", duration = 8, talent = {} }, -- Seduction
  ...
  [108416] = { default = false, cooldown = 60, class = "WARLOCK", talent = {}, defensive = 0.2, duration = 10 }, -- Dark Pact
  [111897] = { default = false, cooldown = 90, class = "WARLOCK", cc = true }, -- Grimoire of Service
  [115268] = { parent = 6358 }, -- Mesmerize
  [ 19505] = { default = false, cooldown = 15, class = "WARLOCK", dispel = true}, -- Dispel
  ...
  [171152] = { default = false, cooldown = 60, class = "WARLOCK" , talent = {}, cc = "stun", duration = 2}, -- Meteor Strike
  ...
  [212295] = { default = false, cooldown = 45, class = "WARLOCK", talent = {221703}, defensive = 0.5, immune = "spell", duration = 5, dispellable = true }, -- Nether Ward
  ...
  [  5782] = { default = false, class = "WARLOCK", cc = "disorient", cast = 1.7, duration = 6, aura = {118699} }, -- Fear
  ...
  [205179] = { default = false, cooldown = 60, class = "WARLOCK", specID = { 265 }, important = true, offensive = true, duration = 15, aura = {}, talent = {} }, -- Phantom Singularity
  ...
  [196364] = { default = false, class = "WARLOCK", specID = { 265 }, cc = "silence", duration = 4 }, -- Unstable Affliction (Silence)
