local data = {
  ...
  [  1122] = { default = true, cooldown = 180, class = "WARLOCK", cc = true, offensive = true }, -- Summon Infernal
  [  6358] = { default = true, cooldown = 30, class = "WARLOCK", cast = 1.7, cc= "disorient", duration = 8 }, -- Seduction
  ...
  [108501] = { default = true, cooldown = 90, class = "WARLOCK", cc = true }, -- Grimoire of Service
  ...
  [  5782] = { default = true, class = "WARLOCK", cc = "disorient", cast = 1.7, duration = 6 }, -- Fear

  -- Affliction

  [  5484] = { default = true, cooldown = 40, class = "WARLOCK", specID = { 265 }, talent = {48018,6789}, cc = "disorient", duration = 8 }, -- Howl of Terror
  ...
  [205179] = { default = true, cooldown = 60, class = "WARLOCK", specID = { 265 }, important = true, duration = 15 }, -- Phantom Singularity
