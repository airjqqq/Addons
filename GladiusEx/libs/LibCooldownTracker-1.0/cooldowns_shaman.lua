local data = {
  ...
  [ 51485] = { default = true, cooldown = 30, class = "SHAMAN", cc = "root", replaces = {196932,192058}, duration = 5, aura = {64695} }, -- Earthgrab Totem
  ...
  -- [204331] = { default = true, cooldown = 45, class = "SHAMAN", replaces = {204330,204332}, defensive = true }, -- Counterstrike Totem
  [204331] = { default = true, cooldown = 45, class = "SHAMAN", replaces = {204330,204332}, defensive = true }, -- Counterstrike Totem
  ...
  [ 16166] = { default = true, cooldown = 120, class = "SHAMAN", specID = { 262 }, offensive = 0.2, duration = 20, talent = {} }, -- Elemental Mastery
  ...
  [210714] = { default = true, cooldown = 30, class = "SHAMAN", specID = { 262 }, offensive = 0.5, cast = 2, duration = 15 }, -- Icefury
  [ 51886] = { default = true, cooldown = 8, class = "SHAMAN", specID = {262,263}, dispel = true, cooldown_starts_on_dispel = true },  -- Remove Corruption
  [ 77505] = { default = true, class = "SHAMAN", specID = {262}, cc = "stun", duration = 1.5 },  -- Earthquake
  ...
  [108280] = { default = true, cooldown = 180, class = "SHAMAN", specID = { 264 }, defensive = 0.2, duration = 6 }, -- Healing Tide Totem
  [157153] = { default = true, cooldown = 30, class = "SHAMAN", specID = { 264 }, defensive = 0.1 }, -- Cloudburst Totem
  [198838] = { default = true, cooldown = 60, class = "SHAMAN", specID = { 264 }, defensive = 0.2, duration = 15, talent = {207399} }, -- Earthen Shield Totem
  [207399] = { default = true, cooldown = 300, class = "SHAMAN", specID = { 264 }, defensive = 1, duration = 30, talent = {198838} }, -- Ancestral Protection Totem
