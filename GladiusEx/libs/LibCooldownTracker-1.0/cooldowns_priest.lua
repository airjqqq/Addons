local data = {
  ...
  [ 32375] = { default = true, cooldown = 15, class = "PRIEST", cast = 1.5, dispel = true }, -- Mass Dispel
  [   605] = { default = true, class = "PRIEST", cc = "disorient", duration = 8, cast = 1.8 }, -- Mind Control
  [ 65081] = { default = true, class = "PRIEST", sprint = true, duration = 3 }, -- Body and Soul
  ...
  [ 62618] = { default = true, cooldown = 180, class = "PRIEST", specID = { 256 }, defensive = 0.25, duration = 10}, -- Power Word: Barrier
  ...
  [197871] = { default = true, cooldown = 60, class = "PRIEST", specID = { 256 }, offensive = 0.15, duration = 8 }, -- Dark Archangel
  ...
  [  2060] = { default = true, class = "PRIEST", specID = { 257 }, cast = 2.5, heal = true }, -- Heal
	...
	[200200] = { default = true, cooldown = 60, class = "PRIEST", specID = { 257 }, cc = "stun", duration = 5, talent = {200196}, aura = {88625} }, -- Holy Word: Chastise (Stun)
	[221660] = { default = true, class = "PRIEST", specID = { 257 }, defensive = 0, immune = "shotinterrupt"}, -- Holy Word: Chastise (Stun)

  -- Shadow

  [ 15286] = { default = true, cooldown = 180, class = "PRIEST", specID = { 258 }, defensive = 0.2, duration = 15}, -- Vampiric Embrace
