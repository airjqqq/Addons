local data = {
  ...
  [213602] = { default = true, cooldown = 30, class = "PRIEST", specID = { 257 }, defensive = 1, immune = "all", duration = 6 },
  ...
  [205065] = { default = false, cooldown = 60, class = "PRIEST", specID = { 258 }, offensive = true, cast = 1.65 }, -- Void Torrent
  [ 34914] = { default = false, class = "PRIEST", specID = { 258 }, important = true, cast = 1.5 }, -- Vampiric Touch
