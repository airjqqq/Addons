local data = {
  ...
  [119381] = { default = true, cooldown = 45, class = "MONK", replaces = {116844}, cc = "stun", duration = 5 }, -- Leg Sweep
  ...
  [115310] = { default = true, cooldown = 180, class = "MONK", specID = { 270 }, defensive = true }, -- Revival
  ...
  [198664] = { default = true, cooldown = 180, class = "MONK", specID = { 270 }, defensive = true }, -- Invoke Chi-Ji, the Red Crane
