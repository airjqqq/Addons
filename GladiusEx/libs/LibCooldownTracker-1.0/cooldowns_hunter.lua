local data = {
  ...
  [  5384] = { default = true, cooldown = 30, class = "HUNTER", defensive = 0.2 }, -- Feign Death
  [109304] = { default = true, cooldown = 120, class = "HUNTER", defensive = 0.3 }, -- Exhilaration (Beast Mastery, Survival)
  ...
  -- [209997] = { default = true, cooldown = 30, class = "HUNTER", defensive = 0.2  }, -- Play Dead
  [118922] = { default = true, class = "HUNTER", sprint = true, duration = 8 }, -- Posthaste
  ...
  [ 19577] = { default = true, cooldown = 60, class = "HUNTER", specID = { 253 }, cc = "stun", duration = 5, aura = {19577,24394} }, -- Intimidation
  [109248] = { default = true, cooldown = 45, class = "HUNTER", specID = { 253, 254 }, cc = "stun", duration = 3, aura = {117526} }, -- Binding Shot
  ...
  [186387] = { default = true, cooldown = 20, class = "HUNTER", specID = { 254 }, cc = "disorient", duration = 4, aura = {224729} }, -- Bursting Shot
  ...
  [187650] = { default = true, cooldown = 20, class = "HUNTER", specID = { 255 }, cc = "incapacitate", aura = {3355}, duration = 8, talent = {203340} }, -- Freezing Trap
  [203340] = { default = true, cooldown = 20, class = "HUNTER", specID = { 255 }, cc = "incapacitate", aura = {203337}, duration = 5 }, -- Freezing Trap
