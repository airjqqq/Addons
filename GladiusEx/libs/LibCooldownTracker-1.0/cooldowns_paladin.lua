local data = {
	  ...
	  [  1022] = { default = true, cooldown = 300, class = "PALADIN", charges = 2, defensive = true, dispellable = true, duration = 10 }, -- Blessing of Protection
	  ...
	  [115750] = { default = true, cooldown = 90, class = "PALADIN", cc = true, talent = {20066} }, -- Blinding Light
	  ...
	  [210294] = { default = true, cooldown = 45, class = "PALADIN", specID = { 65 }, dispellable = true, offensive = true }, -- Divine Favor
	  ...
	  [184662] = { default = true, cooldown = 120, class = "PALADIN", specID = { 70 }, defensive = true, dispellable = true, duration = 15 }, -- Shield of Vengeance
	  [204939] = { default = true, cooldown = 60, class = "PALADIN", specID = { 70 } }, -- Hammer of Reckoning
	  [205191] = { default = true, cooldown = 60, class = "PALADIN", specID = { 70 }, talent = {}, defensive = true, duration = 10 }, -- Eye for an Eye
	  [205273] = { default = true, cooldown = 30, class = "PALADIN", specID = { 70 }, offensive = true }, -- Wake of Ashes
	  [210191] = { default = true, cooldown = 60, class = "PALADIN", specID = { 70 }, defensive = true }, -- Word of Glory
	  [210220] = { default = true, cooldown = 180, class = "PALADIN", specID = { 70 }, offensive = true }, -- Holy Wrath
	  [210256] = { default = true, cooldown = 25, class = "PALADIN", specID = { 70 }, dispel = true }, -- Blessing of Sanctuary
