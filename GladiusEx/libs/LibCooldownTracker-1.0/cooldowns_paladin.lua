local data = {
	  ...
	  [ 20271] = { default = false, cooldown = 12, class = "PALADIN", specID = { 65 }, reduces = {[853] = 10}}, -- Judgment
	  [   498] = { default = false, cooldown = 60, class = "PALADIN", specID = { 65, 66 }, defensive = 0.2, duration = 8}, -- Divine Protection
	  [  6940] = { default = true, cooldown = 120, class = "PALADIN", specID = { 65, 66 }, charges = 2, defensive = 1, duration=10 }, -- Blessing of Sacrifice
	  [ 31821] = { default = false, cooldown = 180, class = "PALADIN", specID = { 65 }, defensive = 0.2, duration = 6 }, -- Aura Mastery
	  [105809] = { default = false, cooldown = 90, class = "PALADIN", specID = { 65 }, offensive = 0.4, duration = 20 }, -- Holy Avenger
	  ...
	  [210294] = { default = false, cooldown = 45, class = "PALADIN", specID = { 65 }, dispellable = true, offensive = true, cooldown_starts_on_aura_fade = true, talent = {} }, -- Divine Favor
	  ...
	  [ 82326] = { default = false, class = "PALADIN", specID = {65}, cast = 2.5, heal = true },  -- Holy Light
	  ...
	  [ 31935] = { default = false, cooldown = 15, class = "PALADIN", specID = { 66 } }, -- Avenger's Shield
	  ...
	  [213644] = { default = false, cooldown = 8, class = "PALADIN", specID = {66,70}, dispel = true, cooldown_starts_on_dispel = true },  -- Remove Corruption
	  ...
	  [205191] = { default = false, cooldown = 60, class = "PALADIN", specID = { 70 }, talent = {}, defensive = 0.2, duration = 10 }, -- Eye for an Eye
	  [205273] = { default = false, cooldown = 30, class = "PALADIN", specID = { 70 }, offensive = true }, -- Wake of Ashes
	  [210191] = { default = false, cooldown = 60, class = "PALADIN", specID = { 70 }, defensive = 0.1, talent = {} }, -- Word of Glory
	  [210220] = { default = false, cooldown = 180, class = "PALADIN", specID = { 70 }, offensive = true, talent = {} }, -- Holy Wrath
	  [210256] = { default = true, cooldown = 25, class = "PALADIN", specID = { 70 }, dispel = true, talent = {} }, -- Blessing of Sanctuary
	  [231895] = { default = false, cooldown = 120, class = "PALADIN", offensive = 0.5, duration = 20, specID = { 66 }, talent = {31884}}, -- Crusade
