local data = {
	-- Warrior
	  ...
	  [ 23920] = { default = true, cooldown = 25, class = "WARRIOR", defensive = 0.5, talent = {}, duration = 3 }, -- Spell Reflection
	  ...
	  [227847] = { default = true, cooldown = 90, class = "WARRIOR", specID = { 71, 72 }, offensive = true, duration = 6, defensive = 0 }, -- Bladestorm (Arms)
