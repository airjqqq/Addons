local data = {
  ...
  [20594 ] = { default = truetrue, cooldown = 120, defensive = 0.1, race = "Dwarf" }, -- Stoneform
  [26297 ] = { default = true, cooldown = 180, offensive = true, race = "Troll" }, --Berserking (Troll)
  [20572 ] = { default = true, cooldown = 120, offensive = true, race = "Orc", talent = {33702,33697} },
  ...
  [28730 ] = { default = true, cooldown = 120, cc = "silence", duration = 2, race = "BloodElf" },
  ...
  [107079] = { default = true, cooldown = 120, race = "Pandaren", cc = "incapacitate", duration = 4},
  [ 20549] = { default = true, cooldown = 120, race = "Tauren", cast = 0.5, cc = "stun", duration = 2},
  [20589 ] = { default = true, cooldown = 60, cc = true, race = "Gnome" },
  [69070 ] = { default = true, cooldown = 120, sprint = true, race = "Goblin" },
  [ 7744 ] = { default = true, cooldown = 120, race = "Scourge" },
  [118358] = { default = true, item = true, important = true },
}
