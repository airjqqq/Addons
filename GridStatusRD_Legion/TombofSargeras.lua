...
GridStatusRaidDebuff:DebuffId(zoneid, 233279, 11, 6, 6) -- Shattering Star
GridStatusRaidDebuff:DebuffId(zoneid, 230345, 12, 6, 6) -- Crashing Comet
GridStatusRaidDebuff:DebuffId(zoneid, 231363, 13, 6, 6) -- Burning Armor
...
GridStatusRaidDebuff:DebuffId(zoneid, 233983, 22, 6, 6) -- Echoing Anguish

-- Harjatan
GridStatusRaidDebuff:BossNameId(zoneid, 30, "Harjatan")
GridStatusRaidDebuff:DebuffId(zoneid, 231770, 31, 5, 5, false, true) -- Drenched
GridStatusRaidDebuff:DebuffId(zoneid, 231998, 32, 6, 6) -- Jagged Abrasion

-- Sisters of the Moon
GridStatusRaidDebuff:BossNameId(zoneid, 40, "Sisters of the Moon")
GridStatusRaidDebuff:DebuffId(zoneid, 236603, 41, 6, 6) -- Rapid Shot
...
GridStatusRaidDebuff:DebuffId(zoneid, 236519, 44, 6, 6) -- Moon Burn
...
GridStatusRaidDebuff:DebuffId(zoneid, 230959, 51, 6, 6) -- Concealing Murk
GridStatusRaidDebuff:DebuffId(zoneid, 232722, 52, 6, 6) -- Slicing Tornado
...
GridStatusRaidDebuff:DebuffId(zoneid, 235117, 71, 6, 6) -- Unstable Soul
GridStatusRaidDebuff:DebuffId(zoneid, 235534, 72, 6, 6) -- Creator's Grace
GridStatusRaidDebuff:DebuffId(zoneid, 235538, 73, 6, 6) -- Demon's Vigor
...
GridStatusRaidDebuff:DebuffId(zoneid, 239739, 82, 6, 6) -- Dark Mark
GridStatusRaidDebuff:DebuffId(zoneid, 234059, 83, 6, 6) -- Unbound Chaos
GridStatusRaidDebuff:DebuffId(zoneid, 240213, 84, 6, 6) -- Chaos Flames
GridStatusRaidDebuff:DebuffId(zoneid, 236604, 85, 6, 6) -- Shadowy Blades
GridStatusRaidDebuff:DebuffId(zoneid, 236494, 86, 6, 6, false, true) -- Desolate
...
GridStatusRaidDebuff:DebuffId(zoneid, 234295, 93, 6, 6, false, true) -- Armageddon Rain
GridStatusRaidDebuff:DebuffId(zoneid, 240908, 94, 6, 6) -- Armageddon Blast
GridStatusRaidDebuff:DebuffId(zoneid, 239932, 95, 6, 6, false, true) -- Felclaws
GridStatusRaidDebuff:DebuffId(zoneid, 240911, 96, 6, 6, false, true) -- Armageddon Hail
