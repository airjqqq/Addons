	...
	for s,n in pairs(AVR.guiSceneClasses) do
		...
		ret.newScene.args[n] = {
			...
			func =	function()
						...
						if ns then Core.sceneManager:AddScene(ns) end
					end
		}
		i=i+1
	end
...
Core.defaultOptions = {
	profile = {
		...
		acceptScenesFromRaid = true,
		acceptScenesFromPartyLeader = true,
		acceptScenesFromParty = true,
		acceptScenesFromBG = true,
		acceptScenesFromGuild = true,
		acceptScenesFromWhisper = true,
	}
}
